...
Credits for assets/data taken from other sources in no specific order. Some data was modified prior to use. If an asset required purchase, it has been purchased.
...
- Pokemon images: https://www.pokepedia.fr/index.php?title=Cat%C3%A9gorie:Sprite_Pok%C3%A9mon_(Link:_Battle!)
- Pokemon images: https://archives.bulbagarden.net/wiki/Category:Shuffle_icons
...
- Gen 9 badges: https://bulbapedia.bulbagarden.net/wiki/Generation_IX
...
- Backgrounds for "modern" trainer cards: https://www.pokemon.com/us/pokemon-virtual-backgrounds/
- "Link" icon: https://www.flaticon.com/free-icon/link_282100
- Discord logo: https://www.stickpng.com/img/icons-logos-emojis/tech-companies/discord-round-logo
- Facebook logo: https://commons.wikimedia.org/wiki/File:Facebook_Logo_%282019%29.png
- Instagram logo: https://commons.wikimedia.org/wiki/File:Instagram_icon.png
- Nintendo Network logo: https://commons.wikimedia.org/wiki/File:Nintendo_Network.svg
- Nintendo Switch Online logo: https://www.nintendo.com/eu/media/images/10_share_images/support_9/H2x1_Support_NintendoSwitchOnline.jpg (used as the `og:image` image for https://www.nintendo.com/en-gb/Support/Nintendo-Switch/Nintendo-Switch-Online/Nintendo-Switch-Online-FAQ-1442566.html)
- Patreon logo: https://freebiesupply.com/logos/patreon-logo-2/
- Pinterest logo: https://commons.wikimedia.org/wiki/File:Pinterest-logo.png
- TikTok logo: https://www.vecteezy.com/png/16716485-tiktok-png-icon
- Twitch logo: https://www.stickpng.com/img/icons-logos-emojis/tech-companies/twitch-logo-black-and-purple
- YouTube logo: https://commons.wikimedia.org/wiki/File:Youtube_logo.png
- Twitter logo: https://commons.wikimedia.org/wiki/File:Logo_of_Twitter.svg
- Pokeball favicon: https://www.kindpng.com/imgv/mRRoTJ_pokeballs-in-catching-rate-order-gen-pixel-art/
...
All source code and original assets created by project maintainers/contributors are licensed under the **GNU Affero General Public License v3.0 (AGPLv3)**. See the [LICENSE](https://github.com/jonbarrow/trainercards.studio/blob/master/LICENSE) file for full terms.
...
- **Other third-party assets**: Various images and resources from the wider internet are used with attribution.
